      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-20">
          ...
          <div className="space-y-8">
            <div className="bg-gray-50 p-8 rounded-2xl">
              <h3 className="text-2xl font-bold text-black mb-4">Phylos</h3>
            ...
            <div className="bg-gray-50 p-8 rounded-2xl">
              <h3 className="text-2xl font-bold text-black mb-4">Body Movement</h3>
              <p className="text-gray-700 leading-relaxed">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gray-50 p-8 rounded-2xl">
              <h3 className="text-2xl font-bold text-black mb-4">Beyond Physical Activity</h3>
              <p className="text-gray-700 leading-relaxed">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="text-center group">
            ...
            <h4 className="text-xl font-bold text-black mb-3">Discovery</h4>
          ...
          <div className="text-center group">
            ...
            <h4 className="text-xl font-bold text-black mb-3">Embodiment</h4>
            <p className="text-gray-600 leading-relaxed">
          ...
          <div className="text-center group">
            ...
            <h4 className="text-xl font-bold text-black mb-3">Integration</h4>
            <p className="text-gray-600 leading-relaxed">
